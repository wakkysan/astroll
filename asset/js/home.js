...
$(function(){
    ...
    var resizeCanvas = function() {
        headerWidth = $('#backgroundFull').innerWidth();
        headerHeight = $('#backgroundFull').innerHeight();
    ...
    $( window ).resize( function() {
        ...
        timer = setTimeout( function(){
            $('.astrollImageInner img').css('width', '1px' ); // for IE, Edge
            $canvas.fadeOut( 300, function(){
                cancelAnimFrame( requestId );
                resizeCanvas();
                starAnimation( areaSize );
                $( this ).fadeIn( 300 );
                $('.astrollImageInner img').css('width', 'auto' );  // for IE, Edge
            });
        }, 500 );
    });
